...
def keypoint_eval(predictions, annotations, return_dict, retLevel):
...
def main():
    ...
    parser.add_argument('--retLevel', help='return level', type=int,
                        default=0)
